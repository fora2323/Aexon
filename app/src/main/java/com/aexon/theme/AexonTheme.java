...
public class AexonTheme {
	...
	// Singleton: harus dipanggil sekali di Application.onCreate() sebelum getInstance() dipakai
	...
	// Ambil warna accent1_600 dari wallpaper (Material You, API 31+).
	// ContextCompat.getColor() dipakai biar nggak kena deprecated getResources().getColor(int, Theme)
	// dan tetap aman dipanggil di API level berapa pun.
	@ColorInt
	...
	// Generate seluruh role warna M3 dari 1 seed color dan simpan ke cache,
	// biar getColorXxx() di bawah tinggal lookup Map, nggak recompute tiap dipanggil.
