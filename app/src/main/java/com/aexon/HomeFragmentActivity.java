...
private final Aexon.OnBinderDeadListener binderDeadListener = () -> {
	...
	public void _applyTheme(final AexonTheme _theme) {
		...
		textview1.setTextColor(_theme.getColorSurfaceFix());
		textview2.setTextColor(_theme.getColorSurfaceVariantFix());
		tmp_timer.setTextColor(_theme.getColorSurfaceVariantFix());
		...
		btn1.setButtonBackgroundColor(_theme.getColorSurfaceContainer());
		btn1.setIconTint(_theme.getColorOnSurface());
		btn1.setTextColor(_theme.getColorOnSurface());
		btn1.setButtonStroke((int)SketchwareUtil.getDimension(getContext(), R.dimen.stroke_size), _theme.getColorOutlineVariant());
		btn1.setButtonRippleColor(_theme.getColorOnSurface());
		
		btn2.setButtonBackgroundColor(_theme.getColorSurfaceContainer());
		btn2.setIconTint(_theme.getColorOnSurface());
		btn2.setTextColor(_theme.getColorOnSurface());
		btn2.setButtonStroke((int)SketchwareUtil.getDimension(getContext(), R.dimen.stroke_size), _theme.getColorOutlineVariant());
		btn2.setButtonRippleColor(_theme.getColorOnSurface());
		
		btn3.setButtonBackgroundColor(_theme.getColorSurfaceContainer());
		btn3.setIconTint(_theme.getColorOnSurface());
		btn3.setTextColor(_theme.getColorOnSurface());
		btn3.setButtonStroke((int)SketchwareUtil.getDimension(getContext(), R.dimen.stroke_size), _theme.getColorOutlineVariant());
		btn3.setButtonRippleColor(_theme.getColorOnSurface());
		
		btn4.setButtonBackgroundColor(_theme.getColorSurfaceContainer());
		btn4.setIconTint(_theme.getColorOnSurface());
		btn4.setTextColor(_theme.getColorOnSurface());
		btn4.setButtonStroke((int)SketchwareUtil.getDimension(getContext(), R.dimen.stroke_size), _theme.getColorOutlineVariant());
		btn4.setButtonRippleColor(_theme.getColorOnSurface());
	}
