...
public class TerminalActivity extends Activity {
	...
	private void initializeLogic() {
		...
		cardview1.setBackground(new AexonDrawable.Builder(currentTheme.getColorSurfaceContainer()).cornerRadius(SketchwareUtil.getDimension(this, R.dimen.card_radius_medium)).build().build(this));
